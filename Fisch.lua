...
_G[' Table'].SizeUi = (not _G['DYHUB Table'].isWindows and UDim2.fromOffset(600,300)) or UDim2.fromOffset(560,600)
...
ImageButton.Image = "rbxassetid://104487529937663" -- Open image asset ID
...
ImageButton.MouseButton1Click:Connect(function()
    ...
    if isOpen then
        ImageButton.Image = "rbxassetid://104487529937663" -- Replace with close image asset ID
    else
        ImageButton.Image = "rbxassetid://104487529937663" -- Open image asset ID
    end
